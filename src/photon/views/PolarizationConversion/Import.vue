        ...
        <el-card class="padding_in">
          ...
          <el-col :span="12" class="margin">
            <el-form-item label="入射光偏振态">
              <el-select v-model="form.amplitudeType" placeholder="请选择">
                <el-option
...
export default {
  ...
  methods: {
    ...
    buildCreateForm() {
      ...
      param.append("amplitudeType", this.form.amplitudeType);
      ...
      param.append("yphase", this.form.yphase[0].raw);
      param.append("xphase", this.form.xphase[0].raw);
