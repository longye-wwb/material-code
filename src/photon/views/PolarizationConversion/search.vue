<template>
  <el-form label-width="90px">
    ...
    <el-collapse v-model="activeName" accordion> 
      ...
      <el-collapse-item title="入射角" name="3">
        <template slot="title">
          入射角
          <i
      ...
      <!-- <el-collapse-item title="介质材料介电常数" name="1">
        <template slot="title">
          介质材料介电常数
          <i
            class="header-icon el-icon-info marginL"
      ...
      <el-collapse-item title="相对带宽" name="8">
        <template slot="title">
          相对带宽
          <i
            class="header-icon el-icon-info marginL"
        ...
        <div class="flex">
          <el-input v-model="form.bandwidth.gte" controls-position="right">
          </el-input>
          <div class="paddingLR">——</div>
          <el-input v-model="form.bandwidth.lte" controls-position="right">
          </el-input>
        </div>
      </el-collapse-item>
      ...
      <!-- <el-collapse-item title="电容缝隙宽度" name="2">
        <template slot="title">
          电容缝隙宽度
          <i
            class="header-icon el-icon-info marginL"
      ...
      <!-- <el-collapse-item title="中间电容线长" name="9">
        <template slot="title">
          中间电容线长
          <i
            class="header-icon el-icon-info marginL"
            v-if="form.length.gte || form.length.lte"
          ></i>
        </template>
        <div class="flex">
          <el-input v-model="form.length.gte" controls-position="right">
          </el-input>
          <div class="paddingLR">——</div>
          <el-input v-model="form.length.lte" controls-position="right">
          </el-input>
        </div>
      </el-collapse-item> -->
      ...
      <!-- <el-collapse-item title="介质材料厚度" name="4">
        <template slot="title">
          介质材料厚度
          <i
            class="header-icon el-icon-info marginL"
      ...
      <!-- <el-collapse-item title="中间电容线宽" name="5">
        <template slot="title">
          中间电容线宽
          <i
            class="header-icon el-icon-info marginL"
      ...
      <!-- <el-collapse-item title="两端线宽" name="8">
        <template slot="title">
          两端线宽
          <i
            class="header-icon el-icon-info marginL"
            v-if="form.widthLength"
          ></i>
        </template>
        <div class="flex">
          <el-input v-model="form.widthLength" controls-position="right">
          </el-input>
        </div>
      </el-collapse-item> -->
