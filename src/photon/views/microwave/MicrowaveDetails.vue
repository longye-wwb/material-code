      ...
      <el-col :span="17">
        ...
        <el-card class="margin">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="6"
              >基底厚度-(t1): {{ tableData.baseThickness }}（mm）</el-col
            >
            <el-col :span="6">介质介电常数: {{ tableData.dielectric }}</el-col>
            <el-col :span="6"
              >结构外环边长-(l): {{ tableData.length }}（mm）</el-col
            >
          </el-row>
          <el-row :gutter="20" class="margin">
            <el-col :span="6">介质材料: {{ tableData.mediumMaterial }}</el-col>
            <el-col :span="6"
              >介质厚度-(t2): {{ tableData.mediumThickness }}</el-col
            >
            <el-col :span="6">结构周期-(p): {{ tableData.period }}</el-col>
            <el-col :span="6"
              >结构材料: {{ tableData.structureMaterial }}</el-col
            >
          </el-row>
          <el-row :gutter="20" class="margin">
            <el-col :span="6"
              >结构厚度: {{ tableData.structureThickness }}</el-col
            >
            <el-col :span="6">结构宽度-(w): {{ tableData.width }}</el-col>
          </el-row>
        </el-card>
      </el-col>
      <el-col :span="7">
        <el-card class="margin">
          ...
          <img class="imgW" src="@/assets/wbzdxs.png" alt="" />
        </el-card>
      </el-col>
    </el-row>
    ...
    patchTableData() {
      this.$postserver.getData(
        ...
        function (response) {
          ...
          this.echarsdata = response.data.waveDtos;
