<!--
 * @Descripttion: 红外宽带位相调控
 * @version: v1.0.2
 * @Author: payne (wenyi)
 * @Date: 2021-06-29 17:11:20
 * @LastEditors: payne (wenyi)
 * @LastEditTime: 2021-06-29 18:47:55
-->
<template>
  <div>
    ...
    <el-row :gutter="20">
      <el-col :span="17">
        ...
        <el-card class="margin">
          ...
          <el-row :gutter="20" class="margin">
            ...
            <el-col :span="6">基底介电常: {{ tableData.baseConstant }}</el-col>
          </el-row>
          <el-row :gutter="20" class="margin">
      ...
      <el-col :span="7">
        <el-card class="margin">
          ...
          <img class="AimgHight center" src="@/assets/hwkdwxtk.png" alt="" />
        </el-card>
      </el-col>
    </el-row>
    ...
    <el-card class="margin"
      ><div slot="header" class="clearfix">
        <span>图像</span>
        <div style="color:rgba(0,0,0,0.5);font-weight: 1000;">注：以下图像分别为功能材料的红外波段共极化相位和振幅曲线
</div>
      </div>
...
import Echars from "../InfraredPhaseControl/echars";
import Echars02 from "../InfraredPhaseControl/echars02";
