 ...
 * @LastEditTime: 2021-06-29 18:43:48
-->
<template>
  <div>
    ...
    <el-card class="margin">
      <div slot="header" class="clearfix">
        <span>图像</span>
         <div style="color:rgba(0,0,0,0.5);font-weight: 1000;">注：以下图像分别为功能材料的红外波段交叉极化振幅和相位曲线
</div>
...
import Echars from "../InfraredPolarizationConversion/echars.vue";
import Echars02 from "../InfraredPolarizationConversion/echars02";
