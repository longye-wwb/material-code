 ...
 * @version: v1.0.2
 * @Author: payne (wenyi)
 * @Date: 2021-06-29 17:24:12
 * @LastEditors: payne (wenyi)
 * @LastEditTime: 2021-06-30 11:49:16
-->
<template>
  <div>
...
import Echars from "../MicrowaveAbsorber/echars";
export default {
    ...
    patchTableData() {
      this.$postserver.getData(
        ...
        function (response) {
          ...
          this.echarsdata = response.data.data.absorptionRateDtos;
