<template>
  <el-row align="middle" :gutter="20">
      ...
      <el-card class="box-card">
        ...
        <el-row>
          ...
          <el-col style="padding-top: 20px">
            <el-row>
              <el-col :span="12">
                <el-button @click="createFormVisible = true"
                  >导入数据</el-button
                >
    ...
    <el-col>
      <el-dialog title="导入数据" :visible.sync="createFormVisible">
        <namo-antenna-create-form
          @success="createFormVisible = false"
          @closed="createFormVisible = false"
        ></namo-antenna-create-form>
      </el-dialog>
    </el-col>
  </el-row>
...
import NamoAntennaCreateForm from "../../components/form/NamoAntennaCreateForm.vue";

export default {
  name: "ManageNanoAntennoMaterialsListView",
  mixins: [PhotonViewMixin],
  components: {
    NanoAntennaAhapeSearchForm,
    PageInput,
    NamoAntennaCreateForm,
  },
  data() {
    return {
  ...
  mounted: function () {
    this.searchForm = Object.assign(
      this.searchForm,
      this.$refs.research.getSearchForm()
    );
    this.patchTableData();
  },
  methods: {
    ...
    buildSearchParam() {
      ...
      console.log(
        "表单检索参数",
        this.searchForm,
        this.searchForm.antennaForm.staticl
      );
