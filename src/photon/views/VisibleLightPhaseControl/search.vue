<template>
  <el-form label-width="90px">
    ...
    <el-collapse v-model="activeName" accordion>
      ...
      <el-collapse-item title="入射角" name="6">
        <template slot="title">
          入射角
          <i
      ...
      <el-collapse-item title="高效带宽" name="2">
        <template slot="title">
          高效带宽
          <i class="header-icon el-icon-info marginL" v-if="form.eff.gte || form.eff.lte"></i>
        </template>
        <div class="flex">
          <el-input
      ...
      <!-- <el-collapse-item title="天线材料" name="3">
        <template slot="title">
          天线材料
          <i
            class="header-icon el-icon-info marginL"
      ...
      <!-- <el-collapse-item title="天线介电常数" name="4">
        <template slot="title">
          天线介电常数
          <i
            class="header-icon el-icon-info marginL"
      ...
      <el-collapse-item title="天线类型" name="5">
        <template slot="title">
          天线类型
      ...
      <!-- <el-collapse-item title="天线长轴" name="6">
        <template slot="title">
          天线长轴
          <i
            class="header-icon el-icon-info marginL"
      ...
      <!-- <el-collapse-item title="天线短轴" name="7">
        <template slot="title">
          天线短轴
          <i
            class="header-icon el-icon-info marginL"
      ...
      <!-- <el-collapse-item title="天线高度" name="8">
        <template slot="title">
          天线高度
          <i
            class="header-icon el-icon-info marginL"
      ...
      <!-- <el-collapse-item title="基底材料" name="9">
        <template slot="title">
          基底材料
          <i
            class="header-icon el-icon-info marginL"
      ...
      <!-- <el-collapse-item title="基底介电常数" name="10">
        <template slot="title">
          基底介电常数
          <i
            class="header-icon el-icon-info marginL"
      ...
      <el-collapse-item title="基底类型" name="11">
        <template slot="title">
          基底类型
      ...
      <!-- <el-collapse-item title="基底厚度" name="12">
        <template slot="title">
          基底厚度
          <i
            class="header-icon el-icon-info marginL"
      ...
      <!-- <el-collapse-item title="基底边长" name="13">
        <template slot="title">
          基底边长
          <i
            class="header-icon el-icon-info marginL"
...
export default {
  ...
  methods: {
    ...
    emptyForm() {
      ...
      this.form.longAxis = { gte: "", lte: "" };
      this.form.minorAxis = { gte: "", lte: "" };
