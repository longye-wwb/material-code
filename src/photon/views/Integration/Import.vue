    ...
    <el-form label-width="150px">
      <el-row>
        <el-card class="padding_in">
          ...
          <el-col :span="12" class="margin">
            <el-form-item label="方形环周期">
              <el-input
                v-model="form.p"
                placeholder="请输入方形环周期"
              ></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12" class="margin">
            <el-form-item label="窄带透射率">
              <file-input
                v-model="form.narrowband"
                tips="请选择相应文件"
              ></file-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" class="margin">
            <el-form-item label="宽带吸收率">
              <file-input
                v-model="form.broadband"
                tips="请选择相应文件"
              ></file-input>
            </el-form-item>
          </el-col>
...
export default {
  name: "PolarizationConversionForm",
  components: {
    FileUpload,
    FileInput,
    breadcrumb,
  ...
  methods: {
    ...
    buildCreateForm() {
      ...
      param.append("p", this.form.p);
      param.append("broadband", this.form.broadband[0].raw);
      param.append("narrowband", this.form.narrowband[0].raw);
